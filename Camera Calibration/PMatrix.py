...
def main():
    ...
    # line assumed as the equation for the same is missing
    l = lineGenerator([np.random.randint(1, 10), 451],
                      [np.random.randint(21, 30), 451])
    print(l)
    # calculating the vanishing point coordinates
